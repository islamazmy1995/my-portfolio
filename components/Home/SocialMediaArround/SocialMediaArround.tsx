...
const IconClickableWithAnimation = (props: props) => {
  return (
    <motion.div
      whileHover={{
        y: -3,
        ...
        <div className="flex flex-col space-y-8 justify-center items-center">
          <div className="flex flex-col justify-center items-center space-y-5">
            ...
            <IconClickableWithAnimation
              Icon={GithubIcon}
              href={"https://github.com/islamazmy1995"}
            />
            {/* Linkedin icon */}
            <IconClickableWithAnimation
              Icon={LinkedinIcon}
              href={"https://www.linkedin.com/in/eslam-azmy-043416359/"}
            />
            {/* Instagram Icon */}
            {/* Youtube Icon */}
          </div>
